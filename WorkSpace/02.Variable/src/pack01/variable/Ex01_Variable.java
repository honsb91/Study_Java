...
public class Ex01_Variable {
	public static void main(String[] args) {
		...
		// println : 반드시 변수 하나이거나 합을 통해서 하나로 합쳐진것만 가능함.
		// syso(x) 가능 : 변수가 하나이기 때문에 가능
		// syso(x,y) 불가능 : 변수가 두개임.
		// syso(x + "" + y + "" + z ) ; 51015 숫자형 변수의 합을 막는다.
		// syso(x+y+z) : 숫자형 변수의 합이 출력 됨 .
		
		// 블럭킹 내부에서는 같은 이름의 변수는 선언이 불가능하다.
		// int x ; 오류 : 이미 코드의 윗줄에서 선언이 되어있으므로 선언이 불가능하다.
		// 변수 이름 규칙 : 첫번째 글자는 소문자로 시작하고 의미있는 단어들을 연결해서 사용
		// 단어들의 연결은 대문자로 구분한다.
		// => 자동차의 최대속도를 저장하고싶음 int carMaxSpeed; // 카멜(낙타등처럼 단어들이 연결)
		// 자바 예약어는 사용할 수 없다. ( 보라색으로 나오는 것들 class , void )
