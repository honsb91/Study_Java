...
public class Ex03_CastingString {
	public static void main(String[] args) {
		...
		// String 의 연산 법치 : Concatenation(연결) 
		// String 의 + 는 문자열의 연결을 의미하며 어떤 변수를 String에 더해도 그 변수의 타입은 자동으로 String이 된다.
		...
		//int-> Interger / parse 메소드
		int number1 = Integer.parseInt(str1);
		System.out.println(number1+20);
		int number2 = Integer.parseInt("25");
